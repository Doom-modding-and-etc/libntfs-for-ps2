...
IOP_CFLAGS += -Wall -Os -I../include -I../source/ -std=c17

EE_CFLAGS += -Wall -Os -I../include -I../source/ -std=c17

IOP_OBJS = source/acls.o source/atrrib.o source/attrlist.o \
source/bdmdriver.o source/bitmap.o source/bootsect.o \
source/cache2.o source/collate.o source/compat.o source/compress.o \
...
#Solve these EE side: source/dir.o
EE_OBJS = source/ee/acls.o source/ee/attrlist.o \
source/ee/bitmap.o source/ee/bootsect.o \
source/ee/cache.o source/ee/cache2.o source/ee/collate.o source/ee/compat.o source/ee/compress.o \
...
ifeq ($(PS2DEV),)
	...
	@echo Copying...
	@cp -frv include/iop/ntfs.h $(PS2SDK)/iop/include/
